...
//  "use strict";
  ...
  drawDebug = function(node, probe, probe2) {
...
//      }
    ...
    return function(parent, nodeCollection, out_) {
      ...
      var w = parent.envelope.width();
      var h = parent.envelope.height();
...
//    },
    ...
    expansionCost: (function() {
      var tmp = {l: 0, r: 0, b: 0, t: 0};
      return function(b) {
        tmp.l = b.l;
        tmp.r = b.r;
        tmp.b = b.b;
        tmp.t = b.t;
        LBRTEnvelope.prototype.include.call(tmp, this);
        var enlarged = LBRTEnvelope.prototype.area.call(tmp);
  ...
  function SubTree(envelope, bf, pickseeds) {
    ...
    //the children are stores as a linked list, immediately on the node itself
  ...
  SubTree.prototype = {
    ...
    _insert: (function() {
      ...
      return  function(object, envelope, treeBase) {
